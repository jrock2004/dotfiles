...
ngrep highlight wine winetricks virtualbox docker-compose libffi libyaml \
openssl zlib composer

yaourt -Sy spotify silver-searcher-git scudcloud visual-studio-code
