...
sudo apt-get install -y bash-completion vim vim-scripts python-dev python-pip python3-dev python3-pip neovim build-essential nodejs npm ack-grep tree wget nginx rbenv ruby-build tmux mardown irssi irssi-scripts zsh
